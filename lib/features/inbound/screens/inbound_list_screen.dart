...
class _InboundListScreenState extends ConsumerState<InboundListScreen> {
  ...
  // PERBAIKAN: Fungsi _showAddNewItemDialog dihapus karena tidak digunakan lagi
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        // PERBAIKAN: Cek mounted sebelum panggil ScaffoldMessenger
        if (mounted) {
        ...
        // PERBAIKAN: Cek mounted sebelum panggil setState
        if (mounted) {
